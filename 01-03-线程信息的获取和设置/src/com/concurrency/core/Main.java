...
/**
 * @Classname com.concurrency.com.concurrency.core.Main
 * @Description TODO
 * @Date 2019-02-02 14:06
 * @Created by wangdong
 */
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < 10; i++) {
                pw.println("com.concurrency.com.concurrency.core.Main : Status of Thread " + i + " : " + threads[i].getState());
    ...
    private static void writeThreadInfo(PrintWriter pw, Thread thread, Thread.State state) {
        pw.printf("com.concurrency.com.concurrency.core.Main : Id %d ---- %s\n", thread.getId(), thread.getName());
        pw.printf("com.concurrency.com.concurrency.core.Main : Priority:  %d\n", thread.getPriority());
        pw.printf("com.concurrency.com.concurrency.core.Main : Old State: %s\n", state);
        pw.printf("com.concurrency.com.concurrency.core.Main : New State: %s\n", thread.getState());
        pw.printf("com.concurrency.com.concurrency.core.Main : ************************************\n");
